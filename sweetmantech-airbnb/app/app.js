...
app.setHandler({
    ...
    'HelloAirbnbIntent': function() {
        let speech = this.speechBuilder()
                .addText('Welcome to the comfy cabin! We want your experience to be nothing but royalty. I can change the temperature, tell you the wifi password, help you learn the wifi password, or help you check out. How can I help you?')
